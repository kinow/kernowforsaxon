...
public class FileUtil {      
    ...
    public static Source createSource(String s) throws URISyntaxException {
        String path = createURI(s).toString();
        StreamSource ss = new StreamSource(path);
        ss.setSystemId(path);
        return ss;
    }
     ...
     */
    public static Serializer createDestination(String s) throws URISyntaxException {
        Serializer serializer = new Serializer();
        serializer.setOutputFile(new File(createURI(s)));
        return serializer;
    }
